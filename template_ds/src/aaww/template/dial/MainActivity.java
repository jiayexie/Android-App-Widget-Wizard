...
public class MainActivity extends Activity {
	...
	final static String DIAL_NAME = "dial_name_";
	final static String DIAL_PHONE = "dial_phone_";
	//== define fields here ==
	final static String mDialerNames[] = {"image"};
	final static int mDialerIds[] = {R.id.image};
	final static int mDialerLinkIds[] = {R.id.tag};
	int mAppWidgetId;
	int cConfigured;
